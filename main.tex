...
%%
%%%%PUESTO \pagestyle{plain}                           %número de página centrado en el pie de página
...
% Limpiar encabezado y pie por defecto
\fancyhf{}

% Encabezado (arriba)
% \fancyhead[C]{\footnotesize Lógica Matemática III}
% \fancyhead[C]{\footnotesize Lógica Infinitaria}
\fancyhead[L]{\footnotesize Seminario de Topología B}
\fancyhead[R]{\footnotesize Introducción a la Teoría de Homotopía}


% Pie de página (abajo)
\fancyfoot[L]{\footnotesize Profesores: Andrés Carnero Bravo, Jaime Alejandro García Villeda}
\fancyfoot[R]{\footnotesize Alumno: Francisco García Reyes}

\renewcommand{\headrulewidth}{0.4pt} % arriba
\renewcommand{\footrulewidth}{0.4pt} % abajo


\newcommand{\quot}[2]{\left.#1\middle/#2\right.} %%cociente
