...
\fancyhead[L]{\footnotesize Cóalgebras, coinducción y computación, una brevísima introducción}
\fancyhead[R]{\footnotesize Enrique Ruiz Hernández}

% Pie de página (abajo)
\fancyfoot[L]{\footnotesize Centro de Investigación en Teoría de Categorías y sus Aplicaciones, A.C.}
\fancyfoot[R]{\footnotesize CINVCAT}
