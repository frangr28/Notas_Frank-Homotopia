...
% Encabezado (arriba)
\fancyhead[C]{\footnotesize Introducción a la Teoría de Homotopía}

% Pie de página (abajo)
\fancyfoot[L]{\footnotesize Profesor: Andrés Carnero Bravo}
\fancyfoot[C]{\footnotesize Ayudante: Jaime Alejandro García Villeda}
